...
class Object
  def attributes
    instance_variables.inject({}) do |attrs, name|
  ...
  describe RightAws do
    ...
    describe "latest_snapshot_based_on" do      
      ...
      it "returns snapshots based on the given volume id" do
        ...
        RightAws.latest_snapshot_based_on('some_volume').id.should == 'snapshot_1'
      end
      ...
      it "should return the latest snapshot when there is more than one" do
        ...
        RightAws.latest_snapshot_based_on('some_volume').id.should == 'snapshot_2'
      end      
    end
    ...
    describe "wait_for_create_snapshot" do
      it "should call create_snapshot and return the snapshot when its status is 'completed'" do
        ...
        RightAws.wait_for_create_snapshot('some_volume').attributes.should == new_snapshot.attributes
      end
    end
